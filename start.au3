...
GUICtrlCreateLabel("Building: "&$BUILDING, 10, 100)
GUICtrlCreateLabel("Room Number: "&$ROOM, 10, 130)
Local $idLogin = GUICtrlCreateButton("Login", 220, 100, 60)
Local $idExitButton = GUICtrlCreateButton("Quit Without Launching", 175, 160, 160)
